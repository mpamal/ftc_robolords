 ...
 */
@Autonomous(name = "Left Turn", group = "RoboLords")
public class AutoLeftTurn extends RoboLordsLinearOpMode {
...
//        resetEncoders();
        ...
        if (gamepad1.left_bumper) {
            TURN_90_DEGREES_DISTANCE += 5;
        } else if (gamepad1.right_bumper) {
            TURN_90_DEGREES_DISTANCE -= 5;
        }
        log("turn inches:", "%7f", TURN_90_DEGREES_DISTANCE);
