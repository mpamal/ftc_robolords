 ...
 */
@Autonomous(name = "Blue:10: Push Capball & Park At Center Vortex", group = "RoboLords")
public class AutoPushCapballAndParkAtCenterVortex extends RoboLordsLinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        encoderDrive(DRIVE_NORMAL_SPEED, 48, 48, 30.0);  // S1: Forward 48 Inches with 10 Sec timeout
        encoderDrive(TURN_SPEED, -15, 15, 30.0);  // S2: Turn Left 12 Inches with 4 Sec timeout
//        enableOpticalDistanceSensor(true);
        encoderDrive(DRIVE_NORMAL_SPEED, 36, 36, 50.0);  // S2: Turn Right 12 Inches with 4 Sec timeout
